package com.tronipm.gauufrpe.view.util.xmlpack;
...
public class XmlView extends PlainView {
    ...
    private static String TAG_PATTERN = "(</?(\\w*)(:*)(\\w*))\\s?>?";
    private static String TAG_END_PATTERN = "(/>)";
    //private static String TAG_END_PATTERN2 = "(>)";
    ...
    static {
        ...
        patternColors.put(Pattern.compile(TAG_PATTERN), new Color(0, 0, 255));
        patternColors.put(Pattern.compile(TAG_ATTRIBUTE_PATTERN), new Color(255, 0, 0));
        patternColors.put(Pattern.compile(TAG_END_PATTERN), new Color(0, 0, 255));

        patternColors.put(Pattern.compile(TAG_ATTRIBUTE_VALUE), new Color(127, 0, 127));
        //patternColors.put(Pattern.compile(TAG_END_PATTERN2), new Color(0, 0, 255));
        patternColors.put(Pattern.compile(TAG_COMMENT), new Color(25, 100, 25));
